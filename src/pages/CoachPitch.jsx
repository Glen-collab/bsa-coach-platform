...
// Coach-recruitment landing — pitches the 3-tier MLM commission
// structure to trainers who might refer clients. Was the homepage;
// moved to /become-a-coach when the member-facing Get Started
// landing took /. Content unchanged.
export default function CoachPitch() {
